...
namespace CumulativeAssignment_01.Controllers
{
    public class CoursePageController : Controller
    {
        ...
        [HttpGet]
        // GET: CoursePage/Edit -> A webpage where user can update existing course information
        public IActionResult Edit(int id)
        {
            Course courseToUpdate = _api.CourseInfo(id);

            // redirects to /Views/CoursePage/Edit.cshtml
        ...
        //FORM DATA : coursecode={CourseCode}&teacherid={TeacherId}&coursename={CourseName}
        //Receives information about the course and goes to the list of courses.
        public IActionResult Update(int id,int CourseId, string CourseCode, int TeacherId, DateTime StartDate, DateTime FinishDate, string CourseName)
        {
            //creating Course object
            ...
            courseDetails.FinishDate = FinishDate;
            ...
            _api.updateCourse(id,courseDetails);


            // redirects to /Views/CoursePage/Show.cshtml

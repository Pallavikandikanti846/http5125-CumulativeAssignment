...
namespace CumulativeAssignment_01.Controllers
{
    public class TeacherPageController : Controller
    {
        ...
        //[HttpGet]
        //GET: TeacherPage/Edit -> An article that asks a user if they want to Update teacher data in table
        public IActionResult Edit(int id)
        {
            Teacher teacherToUpdate = _api.GetATeacher(id);
            // redirects to /Views/TeacherPage/Edit.cshtml
            return View(teacherToUpdate);
        }
        [HttpPost]
        //POST: TecherPage/Update -> 
        //Header : Content-Type: application/x-www-url-encoded
        //FORM DATA : teacherfname={TeacherFName}&teacherlname={TeacherLName}&employeenumber={EmployeeNo}&salary={Salary}
        //Updates information about the teacher and goes to the list of teachers.
        public IActionResult Update(int id,string TeacherFName, string TeacherLName, string EmployeeNo, decimal Salary, DateTime HireDate)
        {
            //creating Teacher object
            Teacher teacherDetails = new Teacher();

            teacherDetails.TeacherFName = TeacherFName;
            teacherDetails.TeacherLName = TeacherLName;
            teacherDetails.EmployeeNo = EmployeeNo;
            teacherDetails.HireDate = HireDate;
            teacherDetails.Salary = Salary;
            ...
            _api.updateTeacher(id, teacherDetails);


            // redirects to /Views/TeacherPage/Show.cshtml

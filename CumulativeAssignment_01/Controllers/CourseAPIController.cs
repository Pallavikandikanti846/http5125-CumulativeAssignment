...
namespace CumulativeAssignment_01.Controllers
{
    ...
    public class CourseAPIController : ControllerBase
    {
        ...
        /// <summary>
        /// This method is used to update existing course details received from the user to the database courses table.
        /// </summary>
        /// <param name="courseId">It takes the json course object as an input from the user.</param>
        /// <returns>
        ///  The method returns the upadated course details from courses table.
        /// </returns>
        /// <example>
        /// PUT: "https://localhost:7074/api/CourseAPI/updateCourse/8" 
        /// Header : Content-Type:"application/json"
        /// FORM DATA :
        /// {\"courseid\":\"13\",\"coursecode\":\"IXD5106\",\"teacherid\":\"11\",\"startdate\":\"2025-04-18\",\"finishdate\":\"2025-05-19\",\"coursename\":\"Interaction Design\"}
        /// {"courseId":8,"courseCode":"IXD5106","teacherId":11,"startDate":"2025-04-18T00:00:00","finishDate":"2025-05-19T00:00:00","courseName":"Interaction Design"}
        /// "https://localhost:7074/api/CourseAPI/updateCourse/10" 
        /// FORM DATA :
        /// {\"courseid\":\"14\",\"coursecode\":\"IXD5206\",\"teacherid\":\"12\",\"startdate\":\"2025-04-18\",\"finishdate\":\"2025-05-19\",\"coursename\":\"Product Management\"}
        /// {"courseId":10,"courseCode":"IXD5206","teacherId":12,"startDate":"2025-04-18T00:00:00","finishDate":"2025-05-19T00:00:00","courseName":"Product Management"}
        /// </example>
        ...
        public Course updateCourse(int courseId,[FromBody] Course courseData)
        {
            ...
            //writing the queries to add the desired data
            command.CommandText = "UPDATE courses SET courseid=@courseid,coursecode=@coursecode,teacherid=@teacherid,startdate=@startdate,finishdate=@finishdate,coursename=@coursename WHERE courseid=@courseid";

...
namespace CumulativeAssignment_01.Controllers
{
    ...
    public class StudentAPIController : ControllerBase
    {
        ...
        /// <summary>
        /// This is a GET request used to access a particular student information present in the students table using a particular id provided by the user.
        /// </summary>
        /// <param name="id">This takes student id as a input from the user.</param>
        /// <returns>
        /// This returns a particular student information who present in the students table.
        /// </returns>
        /// <example>
        ...
        /// This method is used to add new student details received from the user to the database students table.
        /// </summary>
        /// <param name="studentId">It takes the json student object as an input from the user.</param>
        /// <returns>
        ///  The method returns the inserted row number or last inserted student id from students table.
        /// </returns>
        /// <example>
        /// PUT: "https://localhost:7074/api/StudentAPI/updateStudent/1" 
        /// Header : Content-Type:"application/json"
        /// FORM DATA :
        /// {\"studentfname\":\"Pallavi\",\"studentlname\":\"Kandikanti\",\"studentnumber\":\"N1751\"}
        /// {"studentId":1,"studentFName":"Pallavi","studentLName":"Kandikanti","studentNumber":"N1751","enrolDate":"0001-01-01T00:00:00"}
        /// FORM DATA :
        /// "https://localhost:7074/api/StudentAPI/updateStudent/10" 
        /// {\"studentfname\":\"Sarah\",\"studentlname\":\"Gomez\",\"studentnumber\":\"N1763\,\"enrolDate\":\"2025-04-18\""}
        /// {"studentId":10,"studentFName":"Sarah","studentLName":"Gomez","studentNumber":"N1763","enrolDate":"2025-04-18T00:00:00"}
        /// </example>
